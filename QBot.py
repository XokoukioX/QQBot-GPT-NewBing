...
def cmd_test():
    # cmd = 'cmd.exe S:\Programs\QQ机器人API3.5版202303311937\py\1.bat'
    p = subprocess.Popen("cmd.exe /c" + "S:\Programs\1.bat", stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
...
if __name__ == '__main__':
    server.run(port=5555, host='0.0.0.0', use_reloader=True)
